...
?> <div class="container-fluid">
      ...
      <div class="col">
          <div class="card mt-5">
            <div class="card-title ml-5 my-2">
              <!--Registration Button--> 
              <button type="button" class="btn" data-toggle="modal" data-target="#Registrationcarousel" style="background-color: #745975; color: white ; float: right;" >Add New image </button>
            </div>
    ...
    <!--Registration Modal-->
    <div class="modal" id="Registrationcarousel">
