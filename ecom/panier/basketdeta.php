...
<tr>
  ...
  <td colspan="2"><button type="button" style="float: right; background-color:#aa66cc; border-radius: 15px 30px;" class="btn" id="btnCommander"><i class="fas fa-cart-arrow-down mr-2"></i>Commander</button></td>
</tr> 
