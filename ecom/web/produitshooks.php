...
$requete="SELECT `id`,`nom`,`prix` ,`description`FROM `produits` WHERE `idhookscat`=$souscat ";
}
else
{
$requete="SELECT `id`,`nom`,`prix`,`description` FROM `produits` WHERE NOT `idhookscat`=0 AND `nv`=1" ;
}
        ...
        <h2 class="h2-responsive product-name">
          ...
          <div>          
            <p class="description-prd">
              <?php echo substr($data['descr'],0,40)?>...</p>
            </p>
